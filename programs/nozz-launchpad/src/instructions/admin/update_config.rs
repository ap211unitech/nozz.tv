...
use crate::{error::NozzError, NozzLaunchpadConfig, CREATOR_TOKEN_MINT_DECIMALS};
...
pub struct UpdateConfig<'info> {
    #[account(
        mut,
        constraint = authority.key() == nozz_launchpad_config.authority @ NozzError::UnAuthorized
    )]
